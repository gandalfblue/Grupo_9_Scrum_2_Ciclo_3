				...
				<div class="row ">
					<div class="col-xl-4 col-lg-5 col-md-7 col-sm-6">
						...
						id="cedula_cliente" oninput="traerNombreCliente()">
									...
									<div class="col-xl-8 col-lg-7 col-md-5 col-sm-6">
										<div class="input-group input-group-sm mb-3">
								...
								<div class="row justify-content-end mt-3">
									<div class="col-xl-6 col-lg-5 col-md-10 col-sm-10">
										<div class="input-group input-group-sm mb-3">
											<span class="input-group-text" id="basic-addon1">Total IVA</span>
											<input type="text" class="form-control" id="total_iva">
										</div>
									</div>
								</div>
